...
INSERT INTO `movie` (`idMovie`, `title`, `releaseYear`, `duration`, `note`, `synopsis`, `poster`, `idDirector`) VALUES
	...
	(33, 'Titre12', '2000', 2000, 3, 'Syopniosqkdlsdq', 'azeazeaz', 9);
...
-- Listage des données de la table kevin_cinema.movie_theme : ~17 rows (environ)
...
-- Listage des données de la table kevin_cinema.person : ~17 rows (environ)
INSERT INTO `person` (`idPerson`, `firstname`, `surname`, `sex`, `birthdate`, `picture`) VALUES
	...
	(57, 'ActeurASupprimer', 'test', 'M', '2024-04-01', 'azeaze');
...
-- Listage des données de la table kevin_cinema.play : ~16 rows (environ)
