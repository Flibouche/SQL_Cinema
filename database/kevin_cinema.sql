...
-- Listage des données de la table kevin_cinema.actor : ~14 rows (environ)
...
-- Listage des données de la table kevin_cinema.director : ~5 rows (environ)
...
INSERT INTO `movie` (`idMovie`, `title`, `releaseYear`, `duration`, `note`, `synopsis`, `poster`, `idDirector`) VALUES
	...
	(3, 'Pulp Fiction', '1994', 149, 4.5, 'L&#039;odyss&eacute;e sanglante et burlesque de petits malfrats dans la jungle de Hollywood &agrave; travers trois histoires qui s&#039;entrem&ecirc;lent.', 'https://www.affiche-cine.com/images/thumb-518x690/14/41043941436113963340.jpg', 3),
	...
	(35, 'FilmASupprimer', '2000', 120, 5, 'AZerty', 'Azerty', 1);
...
-- Listage des données de la table kevin_cinema.person : ~18 rows (environ)
INSERT INTO `person` (`idPerson`, `firstname`, `surname`, `sex`, `birthdate`, `picture`) VALUES
	(1, 'Elijah', 'Wood', 'M', '1981-01-28', 'https://fr.web.img6.acsta.net/c_310_420/pictures/14/12/04/10/36/015552.jpg'),
	...
	(59, 'Test', 'suppr', 'M', '2024-04-03', 'aze'),
	(60, 'TestDirector', 'Test', 'F', '2024-04-03', 'Test');
...
-- Listage des données de la table kevin_cinema.play : ~18 rows (environ)
