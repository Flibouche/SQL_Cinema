        ...
        <div class="actors__content">
            ...
            ?>
                <figure class="actor__card">
                    ...
                    <figcaption class="actors__main" href="index.php?action=actorsDetails&id=<?= $actor["idActor"] ?>"><?= $actor["firstname"] . " " . $actor["surname"] . "<br>" ?></figcaption>
                </figure>
            <?php
            }
            ?>
