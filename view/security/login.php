...
<section class="login section" id="register" aria-label="Sign In">
    <div class="login__container container grid">
        ...
        <form action="index.php?action=login" method="POST">
            ...
            <button class="main__button form" type="submit" name="submit" value="Sign In" aria-label="Sign In Button">
                <span>Sign In</span>
            </button>
